...
import (
	votingmodule "cosmos-weighted-governance-sdk/x/voting/module"
...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	votingIBCModule := votingmodule.NewIBCModule(app.appCodec, app.VotingKeeper)
	ibcRouter.AddRoute(votingmoduletypes.ModuleName, votingIBCModule)
