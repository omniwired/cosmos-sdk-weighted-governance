...
// NewRootCmd creates a new root command for cosmos-weighted-governance-sdkd. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           app.Name + "d",
		Short:         "cosmos-weighted-governance-sdk node",
		SilenceErrors: true,
